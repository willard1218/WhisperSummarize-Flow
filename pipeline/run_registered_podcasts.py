...
def download_single_podcast(rss_url: str, output_dir: Path, run_date: Optional[date], downloader_bin: Path, title_hint: str = "") -> subprocess.CompletedProcess:
...
def sync_podcast_latest(source_url: str, output_dir: Path, run_date: Optional[date], debug_mode: bool = False) -> PodcastSyncResult:
    """
